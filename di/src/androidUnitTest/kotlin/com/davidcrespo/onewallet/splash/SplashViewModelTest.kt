...
class SplashViewModelTest {
    ...
    @Test
    fun `cuando se recibe IsOnboardingCompleted, actualiza el estado con el valor del repositorio`() =
    ...
    @Test
    fun `cuando se recibe LoadMarkets, se llama al UseCase para precargar stocks y crypto`() =
        runTest(mainDispatcherExtension.testDispatcher) {
