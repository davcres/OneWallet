...
import com.davidcrespo.onewallet.core.generated.resources.select_asset_cd
import com.davidcrespo.onewallet.core.generated.resources.unselect_asset_cd
import com.davidcrespo.onewallet.core.composables.modifiers.animations.bounceClick
import com.davidcrespo.onewallet.core.models.flagResource
...
fun MarketListItem(
    ...
    Row(
        ...
        if (marketType == MarketType.GLOBAL && region != null) {
            Image(
                painter = painterResource(region.flagResource),
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = if (isSelected) stringResource(Res.string.unselect_asset_cd) else stringResource(Res.string.select_asset_cd),
