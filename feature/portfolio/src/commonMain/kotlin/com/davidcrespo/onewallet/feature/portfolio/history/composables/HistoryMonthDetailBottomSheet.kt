...
import com.davidcrespo.onewallet.core.generated.resources.investments_of_month_fmt
import com.davidcrespo.onewallet.core.models.CurrencyView
import com.davidcrespo.onewallet.core.models.InvestmentView
import com.davidcrespo.onewallet.feature.portfolio.util.getMonthDisplayName
...
fun HistoryMonthDetailBottomSheet(
    ...
    ModalBottomSheet(
        ...
        BoxWithConstraints {
            val maxSheetHeight = maxHeight * 0.80f
            Box(
                Modifier
                    .fillMaxWidth()
...
private fun Header(
    ...
    Box(Modifier.fillMaxWidth()) {
        Column(Modifier.align(Alignment.CenterStart)) {
            ...
            val monthName = getMonthDisplayName(investment.month)

            Text(
                text = stringResource(Res.string.investments_of_month_fmt, monthName, investment.year),
