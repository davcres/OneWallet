...
import com.davidcrespo.onewallet.core.generated.resources.new_quantity_manual
import com.davidcrespo.onewallet.core.generated.resources.new_quantity_manual_info
import com.davidcrespo.onewallet.core.generated.resources.new_quantity_market
...
fun FormQuantitySection(
    ...
    Column(modifier = modifier) {
        Text(
            text = if (investment.type.isMarket()) stringResource(Res.string.new_quantity_market) else stringResource(
                Res.string.new_quantity_manual
            ),
        ...
        if (investment.type.isManual()) {
            ...
            Row(
                ...
                Text(
                    text = stringResource(Res.string.new_quantity_manual_info, investment.originalCurrency.symbol),
