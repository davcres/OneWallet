...
import com.davidcrespo.onewallet.core.generated.resources.cancel_edit_investment_cd
import com.davidcrespo.onewallet.core.generated.resources.update_quantity_action
...
fun FormActionButtons(
    ...
    Row(
        ...
        Button(
            ...
            contentDescription = stringResource(Res.string.cancel_edit_investment_cd),
        ...
        Button(
            text = stringResource(Res.string.update_quantity_action),
            contentDescription = stringResource(Res.string.update_quantity_action),
