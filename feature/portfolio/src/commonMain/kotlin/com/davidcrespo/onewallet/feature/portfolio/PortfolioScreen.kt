...
import com.davidcrespo.onewallet.core.generated.resources.accessibility_not_selected
import com.davidcrespo.onewallet.core.generated.resources.accessibility_selected
import com.davidcrespo.onewallet.core.generated.resources.etf_fetch_error
import com.davidcrespo.onewallet.core.generated.resources.fund_fetch_error
import com.davidcrespo.onewallet.core.generated.resources.onboarding_finished_button
import com.davidcrespo.onewallet.core.generated.resources.onboarding_finished_description
import com.davidcrespo.onewallet.core.generated.resources.onboarding_finished_title
...
import com.davidcrespo.onewallet.feature.portfolio.allocation.AllocationTab
import com.davidcrespo.onewallet.feature.portfolio.components.EmptyInvestments
import com.davidcrespo.onewallet.feature.portfolio.components.Header
import com.davidcrespo.onewallet.feature.portfolio.components.bottomSheet.addInvestment.AddBankBottomSheet
import com.davidcrespo.onewallet.feature.portfolio.components.bottomSheet.addInvestment.AddFundBottomSheet
import com.davidcrespo.onewallet.feature.portfolio.components.bottomSheet.addInvestment.AddInvestmentBottomSheet
import com.davidcrespo.onewallet.feature.portfolio.components.bottomSheet.deleteInvestment.DeleteInvestmentBottomSheet
import com.davidcrespo.onewallet.feature.portfolio.components.bottomSheet.investmentType.InvestmentAttributeBottomSheet
import com.davidcrespo.onewallet.feature.portfolio.components.bottomSheet.updateInvestment.UpdateInvestmentBottomSheet
import com.davidcrespo.onewallet.feature.portfolio.history.HistoryTab
...
import com.davidcrespo.onewallet.feature.portfolio.positions.PositionsTab
import com.davidcrespo.onewallet.feature.portfolio.prices.PricesTab
...
//    }
    ...
    Scaffold(
            ...
            AnimatedVisibility(
                ...
                Column {
                    ...
                    NavigationBar(
                        ...
                        val selectedDescription = stringResource(Res.string.accessibility_selected)
                        val notSelectedDescription = stringResource(Res.string.accessibility_not_selected)
        ...
        val defaultFundError = stringResource(Res.string.fund_fetch_error)
        val defaultEtfError = stringResource(Res.string.etf_fetch_error)
        ...
        if (uiState.showOnboardingCompletionDialog) {
            OWDialog(
                title = stringResource(Res.string.onboarding_finished_title),
                description = stringResource(Res.string.onboarding_finished_description),
                primaryButtonText = stringResource(Res.string.onboarding_finished_button),
                onPrimaryClick = {
