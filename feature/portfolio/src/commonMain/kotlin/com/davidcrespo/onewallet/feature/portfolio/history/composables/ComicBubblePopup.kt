...
fun ComicBubblePopup(
    ...
    var bubbleLeft by remember(anchorCenterX, bubbleWidth) { mutableStateOf(anchorCenterX - bubbleWidth / 2) }
    ...
    Popup(
        ...
        popupPositionProvider = remember(anchorCenterX, bubbleWidth, y) {
            object : PopupPositionProvider {
                override fun calculatePosition(
                    ...
                    val maxOffset = (windowSize.width - bubbleWidth).coerceAtLeast(0)
                    val x = (anchorCenterX - bubbleWidth / 2).coerceIn(0, maxOffset)
                    bubbleLeft = x
        ...
        AnimatedVisibility(
            ...
            ComicBubble(
                ...
                bubbleLeftInWindowPx = bubbleLeft,
