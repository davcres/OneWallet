...
import com.davidcrespo.onewallet.core.generated.resources.add_bank_cd
import com.davidcrespo.onewallet.core.generated.resources.add_bank_title
import com.davidcrespo.onewallet.core.generated.resources.add_other_title
import com.davidcrespo.onewallet.core.generated.resources.asset_manual_quantity_cd
import com.davidcrespo.onewallet.core.generated.resources.asset_name_cd
import com.davidcrespo.onewallet.core.generated.resources.bank_name_label
import com.davidcrespo.onewallet.core.generated.resources.bank_name_placeholder
...
import com.davidcrespo.onewallet.core.generated.resources.other_name_label
import com.davidcrespo.onewallet.core.generated.resources.other_name_placeholder
import com.davidcrespo.onewallet.core.generated.resources.total_money_label
    ...
    Box(Modifier.fillMaxWidth()) {
        Column(Modifier.align(Alignment.CenterStart)) {
            Row {
                ...
                Text(
                    text = if (isBank) stringResource(Res.string.add_bank_title) else stringResource(Res.string.add_other_title),
...
private fun Form(
    ...
    Column {
        Text(
            text = if (isBank) stringResource(Res.string.bank_name_label) else stringResource(Res.string.other_name_label),
        ...
        Text(
            text = stringResource(Res.string.total_money_label),
            style = MaterialTheme.typography.titleMedium,
            color = MaterialTheme.colorScheme.onPrimaryContainer,
            modifier = Modifier.padding(horizontal = 8.dp)
        )
        ...
        TextField(
            ...
            placeholder = "0.0",
            contentDescription = stringResource(Res.string.asset_manual_quantity_cd),
        ...
        Row(
            ...
            Button(
                ...
                contentDescription = stringResource(Res.string.add_bank_cd),
