...
import com.davidcrespo.onewallet.core.generated.resources.add_action
import com.davidcrespo.onewallet.core.generated.resources.add_fund_cd
import com.davidcrespo.onewallet.core.generated.resources.add_new_etf_title
import com.davidcrespo.onewallet.core.generated.resources.add_new_fund_title
import com.davidcrespo.onewallet.core.generated.resources.asset_isin_cd
import com.davidcrespo.onewallet.core.generated.resources.asset_market_quantity_cd
import com.davidcrespo.onewallet.core.generated.resources.cancel_action
import com.davidcrespo.onewallet.core.generated.resources.cancel_add_fund_cd
import com.davidcrespo.onewallet.core.generated.resources.close_cd
import com.davidcrespo.onewallet.core.generated.resources.error_isin_empty
import com.davidcrespo.onewallet.core.generated.resources.error_isin_invalid
import com.davidcrespo.onewallet.core.generated.resources.isin_helper_text
import com.davidcrespo.onewallet.core.generated.resources.isin_label
import com.davidcrespo.onewallet.core.generated.resources.quantity_shares_label
    ...
    Box(Modifier.fillMaxWidth()) {
        Column(Modifier.align(Alignment.CenterStart)) {
            Row {
                ...
                Text(
                    text = if (isFund) stringResource(Res.string.add_new_fund_title) else stringResource(Res.string.add_new_etf_title),
...
private fun Form(
    ...
    Column {
        Text(
            text = stringResource(Res.string.isin_label),
        ...
        TextField(
            ...
            contentDescription = stringResource(Res.string.asset_isin_cd),
        ...
        Row (
            ...
            Text(
                text = stringResource(Res.string.isin_helper_text),
        ...
        Text(
            text = stringResource(Res.string.quantity_shares_label),
            style = MaterialTheme.typography.titleMedium,
            color = MaterialTheme.colorScheme.onPrimaryContainer,
            modifier = Modifier.padding(horizontal = 8.dp)
        )
        ...
        TextField(
            ...
            placeholder = "0.0",
            contentDescription = stringResource(Res.string.asset_market_quantity_cd),
        ...
        Row(
            ...
            Button(
                ...
                contentDescription = stringResource(Res.string.cancel_add_fund_cd),
            ...
            val errorIsinEmpty = stringResource(Res.string.error_isin_empty)
            val errorIsinInvalid = stringResource(Res.string.error_isin_invalid)

            Button(
                text = stringResource(Res.string.add_action),
                contentDescription = stringResource(Res.string.add_fund_cd),
